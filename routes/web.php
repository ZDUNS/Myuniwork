...
Route::get('/{places}/show', [PlacesController::class, 'show'])->name('Places.show')->middleware('isloggedin');
Route::get('/{places}/editing', [PlacesController::class, 'edit'])->name('Places.edit')->middleware('isloggedin');
Route::delete('/{places}/delete', [PlacesController::class, 'destroy'])->name('Places.delete')->middleware('isloggedin');
Route::patch('/{places}/update', [PlacesController::class, 'update'])->name('Places.update')->middleware('isloggedin');